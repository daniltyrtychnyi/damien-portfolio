...
export default () => {
    return (
        <div className="service-collections">
            {serviceCollectionItems.map(({title, description, images, services}, index) => {
                                ...
                                <div className="service-collections__service" key={index}>
                                    <div className="service-collections__service-offer">
                                        ...
                                        <div className="service-collections__service-pricing">
                                            <span className={clsx("service-collections__service-price", {
                                                [`service-collections__service-price--${mode}`]: mode,
                                            })}>
                                                {price}
                                            </span>
                                            <UnderlineLink
