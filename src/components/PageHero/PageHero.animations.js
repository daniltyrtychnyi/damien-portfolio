...
class PageHeroAnimations {
    ...
    constructor() {
        ...
        this.metricItemElements = this.rootElement.querySelectorAll(this.selectors.metricItem)
    ...
    animate() {
        ...
        timeline
            ...
            .from(this.headerMainElement, {
                x: -10,
                opacity: 0,
                duration: 1,
            }, '<')
            .from(this.scrollElement, {
                y: 20,
                opacity: 0,
                duration: 1,
            }, '<')
